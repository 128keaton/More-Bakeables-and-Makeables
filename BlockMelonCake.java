...
public class BlockMelonCake extends Block
{
    protected BlockMelonCake(int par1, int par2)
    {
    ...
    {
        return par1 == 1 ? mod_Desserts.BlockMelonCake.blockIndexInTexture : (par1 == 0 ? mod_Desserts.BlockMelonCakeBottom : (par2 > 0 && par1 == 4 ? mod_Desserts.BlockMelonCakeInside : mod_Desserts.BlockMelonCakeSide));
    }
    ...
    {
        return par1 == 1 ? mod_Desserts.BlockMelonCake.blockIndexInTexture : (par1 == 0 ? mod_Desserts.BlockMelonCakeBottom : mod_Desserts.BlockMelonCakeSide);
    }
    ...
    {
        return mod_Desserts.meloncake.shiftedIndex;
    }
}
