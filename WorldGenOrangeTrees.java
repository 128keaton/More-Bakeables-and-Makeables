...
public class WorldGenOrangeTrees extends WorldGenerator
{
    ...
    public WorldGenOrangeTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenOrangeTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
                ...
                for (int var10 = par3 - var9; var10 <= par3 + var9 && var7; ++var10)
                {
                    for (var11 = par5 - var9; var11 <= par5 + var9 && var7; ++var11)
                    {
                        if (var8 >= 0 && var8 < 256)
                        {
                            ...
                            if (var12 != 0 && var12 != mod_Desserts.OrangeLeaves.blockID && var12 != Block.grass.blockID && var12 != Block.dirt.blockID && var12 != Block.wood.blockID)
                            {
                                var7 = false;
                            }
                        }
            ...
            else
            {
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var14, var11, var16, mod_Desserts.OrangeLeaves.blockID, this.metaLeaves);
                                }
                            }
                        }
                    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        if (var12 == 0 || var12 == mod_Desserts.OrangeLeaves.blockID)
                        {
                    ...
                    if (this.vinesGrow)
                    {
                        for (var11 = par4 - 3 + var6; var11 <= par4 + var6; ++var11)
                        {
                            ...
                            for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                            {
                                ...
                                {
                                    if (par1World.getBlockId(var14, var11, var15) == mod_Desserts.OrangeLeaves.blockID)
                                    {
