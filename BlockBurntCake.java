...
public class BlockBurntCake extends Block
{
    protected BlockBurntCake(int par1, int par2)
    {
    ...
    {
        return par1 == 1 ? mod_Desserts.BlockBurntCake.blockIndexInTexture : (par1 == 0 ? mod_Desserts.BlockBurntCakeBottom : (par2 > 0 && par1 == 4 ? mod_Desserts.BlockBurntCakeInside : mod_Desserts.BlockBurntCakeSide));
    }
    ...
    {
        return par1 == 1 ? mod_Desserts.BlockBurntCake.blockIndexInTexture : (par1 == 0 ? mod_Desserts.BlockBurntCakeBottom : mod_Desserts.BlockBurntCakeSide);
    }
    ...
    {
        return mod_Desserts.burntcakeItem.shiftedIndex;
    }
}
